export const SITE_NAME = "kOS | Simple, extensible, open-source project management tool.";
export const SITE_TITLE = "kOS | Simple, extensible, open-source project management tool.";
...
export const SPACE_SITE_NAME = "kOS Publish | Make your kOS boards and roadmaps public with just one-click. ";
export const SPACE_SITE_TITLE = "kOS Publish | Make your kOS boards public with one-click";
export const SPACE_SITE_DESCRIPTION = "kOS Publish is a customer feedback management tool built on top of kOS";

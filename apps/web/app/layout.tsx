...
export const meta = () => [
  { title: "kOS | Simple, extensible, open-source project management tool." },
  ...
  { property: "og:title", content: "kOS | Simple, extensible, open-source project management tool." },
  {
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="kOS" />
